// Shared Claude trade verifier — used by the cron report AND the paper-trader so
// there is exactly one prompt. verifyTrade(sym, setup, data, apiKey) returns
// { approved: bool, reason: string } or null (no key / API error → fail closed).
